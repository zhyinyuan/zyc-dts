	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "jobprocess">active</#if>" ><a href="${request.contextPath}/jobprocess"><i class="fa fa-circle-o text-blue"></i><span>${I18n.jobprocess_name}</span></a></li>
