(function ($) {
    ...
    myflow.init = function (c, o) {
        ...
        if(o.id){
            ...
            procId = 'proc'+myflow.util.nextId();
        }
        ...
        */
        ...
        if (myflow.config.editable) {
            ...
            function getJson() {
                ...
                var pname = myflow.config.props.props.name.value;
                var pdesc = myflow.config.props.props.desc.value;
                var data = '{pid:"'+procId+'",pname:"'+pname+'",pdesc:"'+pdesc+'",states:{';
        ...
        function restore(data){
            ...
            if(data.pname){
                myflow.config.props.props.name.value=data.pname;
            }

            myflow.config.props.props.desc.value=data.pdesc;
