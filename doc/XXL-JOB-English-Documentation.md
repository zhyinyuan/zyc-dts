...
<bean id="xxlJobExecutor" class="XxlJobExecutor" init-method="start" destroy-method="destroy" >
...
#### Step 1:develp obHandler in the executor project
    - 1, create new java class implent IJobHandler;
...
The scheduling center API service location: AdminBiz.java
